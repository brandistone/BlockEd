...
const ToastContainer: React.FC<ToastContainerProps> = ({ toasts }) => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
      {toasts.map((toast) => (
        <div key={toast.id} className="bg-gray-800 border border-gray-700 rounded-lg p-4 shadow-lg max-w-xs">
    ...
    <div className="bg-gray-900 rounded-lg overflow-hidden border border-gray-800">
      <div className="px-4 py-3 bg-gray-800 flex justify-between items-center">
        <div className="font-mono text-sm text-gray-300">
          {title} <span className="text-blue-400">{language}</span>
        </div>
      ...
      <div className="p-4">
        ...
        <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto">
          <code className="text-sm font-mono text-green-400 whitespace-pre-wrap">{code}</code>
        </pre>
      </div>
    </div>
  )
  ...
  return (
    ...
    >
      <div className="flex items-start">
        <div className="mr-4 mt-1 p-2 bg-blue-900/30 rounded-lg">{icon}</div>
        <div>
            ...
            <div className="mt-6 md:mt-0">
              ...
              >
                ...
                <span className="relative z-10 flex items-center">
                  {isConnecting ? "Connecting..." : walletConnected ? <>Disconnect Wallet</> : <>Connect Wallet</>}
                </span>
              </button>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
              <div>
                ...
                <p className="text-gray-300 mb-6">
                  Blockchain development involves creating applications that operate on decentralized networks. Whether
                  you're new to blockchain or an experienced developer, this section provides resources to help you
                  build secure and efficient blockchain applications.
                </p>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
                ...
                <p className="text-gray-400 text-sm mb-4">
                  This JavaScript example shows how to connect to Ethereum and interact with your deployed smart
                  contracts.
                </p>
                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto">
            ...
            <div className="mt-12">
              ...
              <div className="space-y-4">
                {courses.map((course, index) => (
                  <div
                    key={index}
                    className="bg-gray-900 rounded-lg border border-gray-800 p-5 transition-all duration-300 hover:border-blue-500"
                  >
        ...
        {activeTab === "projects" && (
          <div>
            <div className="mb-8">
              ...
              <p className="text-gray-300 mb-6">
                Apply your skills by working on these blockchain development projects and challenges. Build your
                portfolio and gain real-world experience.
              </p>
            </div>
            ...
            <div className="mt-12 bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg p-8 border border-blue-900/30 text-center">
              ...
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Join our monthly blockchain hackathons and compete with developers from around the world. Build
                innovative solutions and win prizes!
              </p>
